...
require_once 'Formmail_Error.php';
require_once 'Formmail_ActionClass.php';
require_once 'Formmail_ActionForm.php';
require_once 'Formmail_ViewClass.php';
require_once 'googleAdsense.php';

/**
*	Formmail application Controller definition.
*
*	@author		remix.asia
*	@access		public
*	@package	Formmail
*/
class Formmail_Controller extends Ethna_Controller
{
	/**#@+
	*	@access private
	*/
	...
	*/
	var $class = array(
		...
		*/
		...
		'form'			=> 'Formmail_ActionForm',
		'i18n'			=> 'Ethna_I18N',
		'logger'		=> 'Ethna_Logger',
		'plugin'		=> 'Ethna_Plugin',
		'session'		=> 'Ethna_Session',
		'sql'			=> 'Ethna_AppSQL',
		'view'			=> 'Formmail_ViewClass',
		'renderer'		=> 'Ethna_Renderer_Smarty',
		'url_handler'	=> 'Formmail_UrlHandler',
	);
	...
	*/
	var $plugin_search_appids = array(
		...
		*	2. Formmail_Plugin_Foo_Bar
		*	3. Ethna_Plugin_Foo_Bar
		*
		*	'Common', 'Formmail', 'Ethna',
		*/
		'Formmail', 'Ethna',
	);
